...
1% or 50% chance of carrying contraband. If ocers,
...
Given the observed data, we estimate the posterior distribution of the search thresholds via Hamiltonian Monte Carlo (HMC) sampling (Neal, 1994; Duane et al., 1987), a form of Markov chain Monte Carlo sampling.
